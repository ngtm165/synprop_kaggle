...
atom_list=list(range(1,119)) #118
charge_list=[-2,-1,0,1,2,'other'] #6
hybridization=['SP','SP2','SP3','other'] #4
valence=[1,2,3,4,5,6,'other'] #7

bond_type1=[1,2,3,'other'] #4
bond_type2=['normal','increase','decrease'] #3
...
def main():
    ...
    graph_path='./Data/regression/lograte/data_cluster.pkl.gz'
    target='lograte'
