...
class model(nn.Module):
    def __init__(
        ...
        drop_ratio=0.30000000000000004, #default = 0.1
        # lr=lr, ##mới thêm
        # depth=depth, ##mới thêm
    ):
        super(model, self).__init__()
        emb_dim=224 #default = 1024
...
def train(
    ...
    model_path,
    device,
    lr=0.00047800561950712186, ##mới thêm 5e-4
    weight_decay=1.5622422705704912e-06, ##mới thêm 1e-5
    epochs=20,
    current_epoch=0,
    best_val_loss=1e10,
):
    ...
    optimizer = Adam(net.parameters(), lr=0.00047800561950712186, weight_decay=1.5622422705704912e-06) ##default: lr=5e-4, weight_decay=1e-5, chạy main_finetune (2. 1.3023669362312975e-05;  1.1848812109693355e-06)
