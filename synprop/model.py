...
class model(nn.Module):
    def __init__(
        ...
        node_hid_feats=128, #default = 300
...
def train(
    ...
    model_path,
    device,
    lr=0.0007479691731755961, ##mới thêm 5e-4
    weight_decay=4.107989422736249e-05, ##mới thêm 1e-5
    epochs=20,
    current_epoch=0,
    best_val_loss=1e10,
):
    ...
    optimizer = Adam(net.parameters(), lr=0.0007479691731755961, weight_decay=4.107989422736249e-05) ##default: lr=5e-4, weight_decay=1e-5, chạy main_finetune (2. 1.3023669362312975e-05;  1.1848812109693355e-06)
