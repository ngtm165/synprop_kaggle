...
class model(nn.Module):
    def __init__(
        ...
        edge_feat,
        out_dim=1, #default = 1
        num_layer=4, #default = 3
        node_hid_feats=224, #default = 300
        readout_feats=640, #default = 1024
        predict_hidden_feats=128, #default = 512
        readout_option=True, #default=False
        drop_ratio=0.15000000000000002, #default = 0.1
        # lr=lr, ##mới thêm
        # depth=depth, ##mới thêm
    ):
        super(model, self).__init__()
        emb_dim=640 #default = 1024
...
def train(
    ...
    model_path,
    device,
    lr=0.0008886704555984658, ##mới thêm 5e-4
    weight_decay=2.0685487576712284e-05, ##mới thêm 1e-5
    epochs=20,
    current_epoch=0,
    best_val_loss=1e10,
):
    ...
    optimizer = Adam(net.parameters(), lr=0.0008886704555984658, weight_decay=2.0685487576712284e-05) ##default: lr=5e-4, weight_decay=1e-5, chạy main_finetune (2. 1.3023669362312975e-05;  1.1848812109693355e-06)
