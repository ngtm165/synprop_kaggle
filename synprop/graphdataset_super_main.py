...
class ReactionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("\n--- Kết quả cuối cùng ---")
        # print(f"features nodes: {atom_fea_graph}")
...
#         data_path=f'./Data/regression/wb97xd3/{i}/aam_train.csv'
#         graph_path=f'./Data/regression/wb97xd3/its_new/{i}/wb97xd3_aam_train.pkl.gz'
#         target='ea'
#         graphdata=ReactionDataset(data_path,graph_path,target)
#         print(graphdata.__getitem__(8))

#         # --- Thiết lập thư mục và file output ---
#         output_folder = f'output/wb97xd3/{i}'                                  ## <-- THÊM MỚI: Định nghĩa tên thư mục output
...
#         output_filename = 'wb97xd3_aam_train_processed_data.npz'
