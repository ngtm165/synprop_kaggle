...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_path", type=str, default='./Data/regression/cycloadditon/cycloadditon.csv')
    ...
    arg_parser.add_argument("--graph_path", type=str, default='./Data/regression/cycloadditon/its_new/cycloadditon.pkl.gz') #binh thuong bo cho nay
