...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_path", type=str, default='./Data/regression/rad6re/rad6re.csv')
    ...
    arg_parser.add_argument("--graph_path", type=str, default='./Data/regression/rad6re/its_origin/rad6re.pkl.gz') #binh thuong bo cho nay
