...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_path", type=str, default='./Data/regression/RDB7/RDB7.csv')
    ...
    arg_parser.add_argument("--graph_path", type=str, default='./Data/regression/RDB7/its_new/RDB7.pkl.gz') #binh thuong bo cho nay
    arg_parser.add_argument("--model_name", type=str, default="model.pt")
    arg_parser.add_argument("--y_column", type=str, default="dHrxn298")
