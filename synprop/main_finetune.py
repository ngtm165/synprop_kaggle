...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_path", type=str, default='./Data/wb97xd3/rad6re/rad6re.csv')
    ...
    arg_parser.add_argument("--graph_path", type=str, default='./Data/wb97xd3/rad6re/its_new/rad6re.pkl.gz') #binh thuong bo cho nay 
