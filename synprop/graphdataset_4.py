...
class ReactionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in lst_nodes:
            ...
            atom_fea = quantum_features + e_max + [charge_1] + [charge_2] + h_1 + h_2 + atom_hybrid_p_1 + atom_hybrid_p_2 + [neighbor_count_1] + [neighbor_count_1] #atom1 edge3
