...
from synprop.gine_1 import GNN
...
class model(nn.Module):
    def __init__(
        ...
        # Lớp MLP dự đoán cuối cùng
        self.predict = nn.Sequential(
            # Kích thước đầu vào phải khớp với đầu ra của GNN
            torch.nn.Linear(gnn_output_feats, predict_hidden_feats), 
            torch.nn.PReLU(),
            # Nên dùng drop_ratio khác cho MLP này nếu muốn kiểm soát riêng
